  ...
  es: {
    ...
    hero: {
      ...
      stats: [
        ...
        { k: "16%", v: "IVA incluido en checkout" },
        { k: "MXN", v: "Precios transparentes" },
        { k: "CDMX", v: "AVENIDA HOMERO, N°404 PISO 5, COLONIA POLANCO V SECCIÓN, ALCALDIA MIGUEL HIDALGO, CP. 11560, ENTIDAD FEDERATIVA CIUDAD DE MÉXICO."},
      ],
    ...
    tools: {
      ...
      stack: [
        { name: "Unity", role: "Motor 2D / 3D", level: 96 },
        { name: "Unreal Engine", role: "Render de alta fidelidad", level: 88 },
        { name: "Swift / Kotlin", role: "Nativo iOS + Android", level: 91 },
        { name: "React Native", role: "Híbrido multiplataforma", level: 94 },
        { name: "Blender", role: "Modelado y animación", level: 85 },
        { name: "Node / APIs", role: "Backend e integraciones", level: 90 },
      ]
    },
    missionsUI: {
  ...
  en: {
    ...
    hero: {
      ...
      stats: [
        ...
        { k: "16%", v: "VAT included in checkout" },
        { k: "USD", v: "Transparent pricing" },
        { k: "CDMX", v: "AVENIDA HOMERO, N°404 PISO 5, COLONIA POLANCO V SECCIÓN, ALCALDIA MIGUEL HIDALGO, CP. 11560, ENTIDAD FEDERATIVA CIUDAD DE MÉXICO."},
      ],
    ...
    tools: {
      ...
      stack: [
        { name: "Unity", role: "2D / 3D Engine", level: 96 },
        { name: "Unreal Engine", role: "High-fidelity Render", level: 88 },
        { name: "Swift / Kotlin", role: "Native iOS + Android", level: 91 },
        { name: "React Native", role: "Cross-platform Hybrid", level: 94 },
        { name: "Blender", role: "Modeling & Animation", level: 85 },
        { name: "Node / APIs", role: "Backend & Integrations", level: 90 },
      ]
    },
    missionsUI: {
